...
5. Pada bagian **Artifacts** di bawah halaman, klik file **shudoku-debug-apk** untuk mengunduh file `.zip` yang berisi file APK siap pasang ke ponsel Android Anda.
